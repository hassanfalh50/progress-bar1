...
!function(e, t) {
    ...
    E.event = {
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    var t = this || e;
                    return fe.test(t.type) && t.click && S(t, "input") && Ee(t, "click", xe),
                    !1
                },
                trigger: function(e) {
                    var t = this || e;
                    return fe.test(t.type) && t.click && S(t, "input") && Ee(t, "click"),
                    !0
                },
                _default: function(e) {
                    var t = e.target;
    ...
    function Be(e, t, n) {
        ...
        !m.pixelBoxStyles() && Pe.test(a) && Re.test(t) && (r = s.width,
        i = s.minWidth,
        o = s.maxWidth,
    ...
    E.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return "undefined" == typeof e.getAttribute ? E.prop(e, t, n) : (1 === o && E.isXMLDoc(e) || (i = E.attrHooks[t.toLowerCase()] || (E.expr.match.bool.test(t) ? Ze : void 0)),
        ...
        toggleClass: function(i, t) {
            ...
            return "boolean" == typeof t && a ? t ? this.addClass(i) : this.removeClass(i) : b(i) ? this.each(function(e) {
                ...
                if (a) {
                    ...
                    void 0 !== i && "boolean" !== o || ((e = it(this)) && Y.set(this, "__className__", e),
    ...
    E.extend(E.event, {
        trigger: function(e, t, n, r) {
            ...
            if (o = f = a = n = n || w,
            3 !== n.nodeType && 8 !== n.nodeType && !st.test(p + E.event.triggered) && (-1 < p.indexOf(".") && (p = (h = p.split(".")).shift(),
            h.sort()),
            u = p.indexOf(":") < 0 && "on" + p,
            ...
            r || !c.trigger || !1 !== c.trigger.apply(n, t))) {
                if (!r && !c.noBubble && !x(n)) {
                    ...
                    st.test(s + p) || (o = o.parentNode); o; o = o.parentNode)
                        d.push(o),
                        a = o;
